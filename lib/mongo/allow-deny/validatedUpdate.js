...
// Only allow these operations in validated updates.
// Specifically,
// whitelist operations, rather than blacklist, so new complex
// operations that are added aren't automatically allowed.
// A complex
// operation is one that does more than just modify its target
// field.
// For now, this contains all update operations except '$rename'.
...
export default async function validatedUpdate (userId, selector, mutator, options) {
  ...
  // Any allowed returns true means proceed. Throw error if they all fail.
  if (
