...
const PollingObserveDriver = function(options) {
    const self = this;
    ...
    const listenersHandle = listenAll(
    ...
    this._unthrottledEnsurePollIsScheduled().catch(console.error);
...
_.extend(PollingObserveDriver.prototype, {
    ...
    async _pollMongo() {
        ...
        const writesForCycle = self._pendingWrites;
        self._pendingWrites = [];
...
export default PollingObserveDriver;
